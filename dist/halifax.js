...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_Q__ = __webpack_require__(1);
...
var ApiQueue = function ApiQueue(queueParameter) {
    var promise_chain = __WEBPACK_IMPORTED_MODULE_1_Q___default.a.fcall(function () {});

    var successCallback = queueParameter.successCallback;
    var failureCallback = queueParameter.failureCallback;
    var preApiResonse = {};
    var callSequenceLength = queueParameter.callSequence.length - 1;

    var payloadCreator = function payloadCreator(apiSet, paramAppend) {
        var param = {
    ...
    var requestMethod = function requestMethod(apiSet, payload, callback) {
        var path = apiSet.endPoint + apiSet.name;

        __WEBPACK_IMPORTED_MODULE_0_axios___default()(path, payload).then(function (data) {
    ...
    queueParameter.callSequence.forEach(function (async_op, index) {
        var promise_link = function promise_link() {
            var deferred = __WEBPACK_IMPORTED_MODULE_1_Q___default.a.defer();
            var payload = payloadCreator(async_op, preApiResonse[async_op.resultRequest]);

            requestMethod(async_op, payload, function (result) {
...
/* harmony default export */ __webpack_exports__["a"] = (ApiQueue);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ApiQueue__ = __webpack_require__(0);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ApiQueue", function() { return __WEBPACK_IMPORTED_MODULE_0__components_ApiQueue__["a"]; });
...
/***/ })
/******/ ]);
//# sourceMappingURL=halifax.js.map